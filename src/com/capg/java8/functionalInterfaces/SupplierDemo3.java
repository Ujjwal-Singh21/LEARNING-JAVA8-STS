 ...
 * public static void main(String[] args) {
 * 
 * // Creating a Names Array as List List<String> nameList =
 * Arrays.asList("Michael", "James", "Tony"); Supplier<String> supplier = () ->
 * "Hello Ujjwal Again";
 * 
 ...
 * public static void main(String[] args) {
 * 
 * // Keeping list empty so that "orElseGet()" can execute. List<String>
 * nameList = Arrays.asList();
 * 
 * // Supplier<String> supplier = () -> "Hello Ujjwal Again";
 * 
 * System.out.println(nameList.stream().findAny().orElseGet(() ->
 * "Hello Ujjwal Again")); } }
 */
